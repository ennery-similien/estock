/*
  ...
  - You are about to alter the column `CLI_UPD_DATE` on the `clients` table. The data in that column could be lost. The data in that column will be cast from `DateTime(3)` to `DateTime`.
  ...
  - You are about to alter the column `PRO_UPD_DATE` on the `products` table. The data in that column could be lost. The data in that column will be cast from `DateTime(3)` to `DateTime`.
  ...
  - You are about to alter the column `USR_UPD_DATE` on the `users` table. The data in that column could be lost. The data in that column will be cast from `DateTime(3)` to `DateTime`.
...
-- AlterTable
ALTER TABLE `clients` ADD COLUMN `CLI_IS_BLOCKED` BOOLEAN NOT NULL DEFAULT false,
    MODIFY `CLI_UPD_DATE` DATETIME NULL;
