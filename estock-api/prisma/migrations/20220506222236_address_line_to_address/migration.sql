/*
  ...
  - You are about to alter the column `CLI_UPD_DATE` on the `clients` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
...
-- AlterTable
ALTER TABLE `clients` MODIFY `CLI_UPD_DATE` DATETIME NULL;
