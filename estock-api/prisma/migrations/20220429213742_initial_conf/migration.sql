...
CREATE TABLE `addresses` (
    ...
    `ADR_USR_ID` INTEGER NULL,
    `ADR_CLI_ID` INTEGER NULL,
...
CREATE TABLE `telephones` (
    ...
    `TEL_USR_ID` INTEGER NULL,
    `TEL_CLI_ID` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `addresses` ADD CONSTRAINT `USER_ADDRESSES_FK` FOREIGN KEY (`ADR_USR_ID`) REFERENCES `users`(`USR_ID`) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `addresses` ADD CONSTRAINT `CLIENT_ADDRESSES_FK` FOREIGN KEY (`ADR_CLI_ID`) REFERENCES `clients`(`CLI_ID`) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `telephones` ADD CONSTRAINT `USER_TELEPHONES_FK` FOREIGN KEY (`TEL_USR_ID`) REFERENCES `users`(`USR_ID`) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `telephones` ADD CONSTRAINT `CLIENT_TELEPHONES_FK` FOREIGN KEY (`TEL_CLI_ID`) REFERENCES `clients`(`CLI_ID`) ON DELETE NO ACTION ON UPDATE CASCADE;
